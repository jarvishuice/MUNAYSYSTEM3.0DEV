...
class PlantillaHTMLCierreJornada():
    def __init__(self):
        pass
    def procesarAccionesUsuario(self,datos:ReporteEspaciosEntity):
      self.accionesUsuario=""
      if datos.accionesUsuario is not None:
        for i in datos.accionesUsuario:
          self.accionesUsuario += f"""<tr> <td>{i.id} </td><td>{i.idUsuario} </td> <td>{i.nombre} </td><td>{i.idOperacion} </td> <td>{i.accion}</td> <td>{i.fecha} </td></tr>"""
    
    def procesarVentasProductos(self,datos:ReporteEspaciosEntity):
    ...
    def procesarDeudaClientes(self,datos:ReporteEspaciosEntity):
        self.deudaCleintes=''
    ...
    def procesarDetallesOrdenestoday(self,datos:ReporteEspaciosEntity):
        self.detalleOrdenes=''
    ...
    def procesarWalletsActivos(self,datos:ReporteEspaciosEntity):
    ...
    def procesarOrdenesAbiertasHistoricas(self,datos:ReporteEspaciosEntity):
    ...
    def procesarVentasPorCliente(self,datos:ReporteEspaciosEntity):
     self.totalGlobal =0
     self.ordenesClose=''
    ...
    def procesar_ordenes_abiertas(self, datos:ReporteEspaciosEntity):
    ...
    def procesarDetallesPagos(self,datos:ReporteEspaciosEntity):
      #self.Pagos=[]
      self.totalPAYPAL=0
      self.PAGOSGLOBAL=0
      self.pagos=''
    ...
    def getHTML(self, datos: ReporteEspaciosEntity,sede:str):
        ...
        hiloAccionesUsuario=threading.Thread(target=self.procesarAccionesUsuario,args=(datos,))
        ...
        <p> fecha de emision: {datetime.datetime.today()}</p>
         <center> <h1> Reporte del Fin de Jornada Espacios {sede.upper()}</h1> 
...
<tr><th colspan="10" class="total ">Total Recibido:{self.PAGOSGLOBAL}$</th></tr>   
    ...
    <tr> <td colspan=2 class='total'> total:</td> <td class ='total'>{self.totalWalletActivos}$</td></tr>
           ...
           <center><h2> OperacionesUsuario </h2></center>
            <table>
            <tr>
             <center> <th >Id</th></center>
             <center> <th>Id Usuario</th></center>
              <center> <th>Nombre</th></center>
               <center> <th># Operacion</th></center>
                <center> <th>Operacion</th></center>
                 <center> <th>fecha</th></center>
