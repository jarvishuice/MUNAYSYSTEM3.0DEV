...
export function TablaOrdenesEspacios(){
    ...
    const[ordenes,setOrdenes]= React.useState<OrdenesDetalladasEntity[]|null>([])
React.useEffect(()=>{
    async function fechtOrdenes(sede:string) {
       try{ const controladorOrdenes = new OrdenesEspaciosDAO();
...
const [detalles,setDetalles]=React.useState<ConsumoDetalladoEntity[]|null>([])
...
return (
    <div>
            <Sheet sx={{ height: '50vh',mt:10, overflow: 'auto' }}>
            <Table
