...
export function BusquedaEspacios(props:any){
    ...
    return (
      <center><div key="contenedor general" style={{maxHeight:"40vh",overflowY: "auto",marginTop:"70px",maxWidth:"500px"}}>
            <div key="contenedord de los inmput ">
                ...
                WebkitBoxShadow:"1px 1px 4px 0px rgba(0,0,0,0.75);"
                }} variant="contained" onClick={()=>{setMostrar(true),buscar()}}> <SearchIcon/></Button>
            </div>
