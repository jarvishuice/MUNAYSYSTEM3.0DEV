...
export function BusquedaClientesVisitas(props:any){
  ...
  const trigger=(gatillo:Boolean)=>{
    ...
    return (
      ...
      {clientes && clientes.map((x) => (
        <center><li className='bg-primary' key={x.id} onClick={()=>{trigger(false);props.insertarPersona(x)}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="whithe" className="bi bi-person-fill-add mr-2" viewBox="0 0 16 16">
...
export default BusquedaClientesVisitas;